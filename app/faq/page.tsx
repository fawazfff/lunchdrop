...
const faqs = [
  ...
  ["Are claim links safe?", "New LunchDrops use short Supabase-backed claim codes. The private gift payload stays server-side, links expire, and sender/claim status is persisted across devices."],
