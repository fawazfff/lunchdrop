...
export default function AboutPage() {
  return <InfoPage eyebrow="BUILT FOR RUNTIME" title="Lunch should feel personal again." intro="LunchDrop is a social lunch-gifting experience built on Blackbird’s restaurant network through Flynet.">
    <div className="about-stack">
      ...
      <article><h2>The Flynet integration</h2><p>Flynet powers live restaurant discovery, FLY-payment filtering, claim-page location lookup, recipient venue choices, and current restaurant specials. Server-signed claim links protect gift details from URL tampering.</p></article>
